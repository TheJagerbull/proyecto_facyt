...
ALTER TABLE `alm_contiene`
  ...
  ADD CONSTRAINT `alm_contiene_ibfk_3` FOREIGN KEY (`id_estado_articulo`) REFERENCES `alm_estado_articulo` (`id_estado_articulo`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `alm_genera`
  ADD CONSTRAINT `alm_genera_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `dec_usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
