...
class Model_tic_observacion_orden extends CI_Model
{
	...
	function __construct()
	{
		parent::__construct();
         ...
         var $table = 'tic_observacion_orden';
	...
	public function insert_orden($data2='') // funcion para guardar la observacion
	{
		...
		{
			//die_pre($data2);
			$this->db->insert('tic_observacion_orden',$data2);
	...
	public function actualizar_orden($data = '', $id_orden = '') //funcion para actualizar  la solicitud
	{
        if (!empty($data))
        {
            ...
            $this->db->update('tic_observacion_orden', $data);
        }
        return FALSE;
    }
        ...
        public function get_observacion ($id=''){ //funcion para traer las observaciones
            ...
            $campo = $this->db->get('tic_observacion_orden')->result_array();  
           if (!empty($campo))
	...
	//{
		...
		//{
			...
			//$this->db->update('tic_orden_trabajo',$data);
			//return $data['id'];
		//}
		//return FALSE;
	//}
