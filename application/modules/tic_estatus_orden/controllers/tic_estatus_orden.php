...
class Tic_estatus_orden extends MX_Controller 
{
    ...
    { 
        ...
        $this->load->model('tic_estatus_orden/model_tic_estatus_orden', 'model_estatus_orden');
        $this->load->model('tic_observacion/model_tic_observacion_orden', 'model_obser');
