				...
				<div class="col-md-12">
					<div class="awidget full-width">
						<div class="awidget-head">
							<h3>Listado de Cuadrillas</h3>
								<a href="<?php echo base_url() ?>index.php/mnt_cuadrilla/cuadrilla/form_cuadrilla" class="btn btn-success" data-toggle="modal">Agregar Cuadrilla</a>
								<!-- Buscar usuario -->
								<div class="col-lg-6">
									<div class="input-group form">
				                           <input type="text" class="form-control" placeholder="Nombre de cuadrilla...">
