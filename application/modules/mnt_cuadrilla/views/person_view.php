...
<html>
  ...
  <div class="container">
    <h1>Pruebas de Edicion de Cuadrillas con modales en Bootstrap y Datatables</h1>
...
<!--      <tfoot>
  ...
  <script type="text/javascript">
    ...
    function edit_person(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('mnt_cuadrilla/person/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          url = "<?php echo site_url('mnt_cuadrilla/person/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('mnt_cuadrilla/person/ajax_update')?>";
      }
    ...
    function delete_person(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('mnt_cuadrilla/person/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
