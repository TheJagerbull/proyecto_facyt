  ...
  <!--<link type="text/css" href="www/test/css/bootstrap.css" rel="stylesheet" /> -->
    ...
    <body>
        <div id="header">
            ...
            <h1>Universidad de Carabobo<br> Facultad Experimental de Ciencias y Tecnologia<br> SiSAI Decanato<br> Dirección de Tecnología de Información y Comunicación <br> <?php echo ucfirst($cabecera)?></h1>
