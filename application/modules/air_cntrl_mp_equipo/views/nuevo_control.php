        ...
        <div class="col-md-12">
            <div class="awidget full-width">
                <div class="awidget-body">
                    ...
                    <!-- Formulario -->
                    <form class="form-horizontal" action="<?php echo base_url() ?>index.php/air_cntrl_mp_equipo/cntrlmp/crear_cntrl" method="post" name="nuevo_control" id="nuevo_control" enctype="multipart/form-data">
                       ...
                       <!-- FECHA ULTIMO MANTENIMIENTO -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" value=""  placeholder='Cap&aacute;cidad'
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" value=""  placeholder='Periodo en d&iacute;as'
