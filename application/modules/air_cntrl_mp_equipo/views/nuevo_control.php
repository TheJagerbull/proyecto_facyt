        ...
        <div class="col-md-12">
            <div class="awidget full-width">
                <div class="awidget-body">
                    ...
                    <!-- Formulario -->
                    <form class="form-horizontal" action="<?php echo base_url() ?>air_cntrl_mp_equipo/cntrlmp/crear_cntrl" method="post" name="nuevo_control" id="nuevo_control" enctype="multipart/form-data">
