                ...
                <div class="col-md-12">
                    ...
                    <div class="awidget full-width">
                       <div class="awidget-body">
                        ...
                        <?php endif ?>
                        <div class="row">
                            <div class="col-md-3 col-sm-3"><a href="profile.html#"></a></div>
                                        ...
                                        <!-- Profile form -->
                                          ...
                                          <div class="form profile">
                                            ...
                                            <form name="updateUser" class="form-horizontal" action="<?php echo base_url() ?>index.php/user/usuario/modificar_usuario" method="post">
                                                ...
                                                <div class="row">
                                                  <i class="color col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center" >*  Campos Obligatorios</i>
                                                  <div class="form-group col-lg-6 col-sm-6 col-xs-6 text-center">
                                                ...
                                                <!-- TELEFONO -->
                                                <div class="form-group">
                                                  <label class="control-label col-lg-4" for="telefono"><i class="color">*  </i>Telefono</label>
                                                  <div class="col-lg-8">
