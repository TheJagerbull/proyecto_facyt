...
<html>
  <head>
    ...
    <!-- Title here -->
    <title>Login - SiSAI - Intranet FACYT</title>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="logo text-center">
                     ...
                     <h1><a href="">Ingreso a los Servicios de Intranet</a></h1>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="col-md-12">
              <div class="awidget login-reg">
                ...
                <div class="awidget-body">
                  ...
                  <!-- Page title -->
                  <form class="form-horizontal" role="form" action="<?php echo base_url() ?>alfa_master/login" method="post">
                    <div class="form-group">
                      <div class="col-lg-12 text-center">
                        <?php echo form_error('username'); ?>
                        <?php echo form_error('password'); ?>
                      </div>
                      <label for="inputUser1" class="col-lg-2 control-label">Nombre de Usuario</label>
                      <div class="col-lg-10">
