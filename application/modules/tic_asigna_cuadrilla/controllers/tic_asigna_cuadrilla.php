...
class Tic_asigna_cuadrilla extends MX_Controller {
    ...
    function __construct() { //constructor predeterminado del controlador
        ...
        $this->load->model('model_tic_asigna_cuadrilla', 'model_asigna');
...
//        die_pre($this->input->post('estatus'). ' '. $this->input->post('id_cuad'). ' '.$this->input->post('fecha1').' '.$this->input->post('fecha2'));
        ...
        <?php
        $estatus = $this->model_tic_estatus->get_estatus_id($this->input->post('estatus'));
//        echo_pre($estatus);
