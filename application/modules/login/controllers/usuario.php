...
class Usuario extends MX_Controller
{
	...
	public function exist_user()
	{
		...
		{
			$this->form_validation->set_message('exist_user','Combinación de <strong>Nr de Identificacion</strong> y <strong>Contraseña</strong> inválida');
			return FALSE;
		}
		return TRUE;
	}
	...
	public function login()
	{
		...
		if($this->form_validation->run($this))
		{
			...
			if(isset($user))
			{
				...
				$this->session->set_userdata('system_rol',$user['sys_rol']);
				$this->session->set_userdata('user',$user['id_usuario']);
