						...
						<div class="sidey">
							<div class="side-cont">
								<ul class="nav">
									...
									<!-- Modificado por Luis Pérez 2016-05-31, Martes -->
									<li class="has_submenu">
										<a href="#"><i class="fa fa-list fa-lg"></i> Asistencia <span class="caret pull-right"></span></a>
										<!-- Sub menu -->
										<ul style="display: none;">
											...
											<li><?php echo anchor('#', $this->session->userdata('user')['ID'].' - '.$this->session->userdata('user')['id_usuario']); ?></li>
										</ul>
									</li>
