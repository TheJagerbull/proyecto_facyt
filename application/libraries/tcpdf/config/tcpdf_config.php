 ...
 */
define ('PDF_HEADER_LOGO', 'LogoFacyt.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Sistema Inventario');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "usuario: Samuel Heredia - TELEMATICAS\n reporte de solicitudes");
 ...
 */
define ('PDF_IMAGE_SCALE_RATIO', 2.75);
