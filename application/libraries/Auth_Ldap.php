...
class Auth_Ldap {
     ...
     * @return bool 
     */
    public function getProxy_user(){ return $this->proxy_user; }
    public function setProxy_user($x){ $this->proxy_user=$x; }
    public function getProxy_pass(){ return $this->proxy_pass; }
    public function setProxy_pass($x){ $this->proxy_pass=$x; }
    public function getHosts(){ return $this->hosts; }
    public function setHosts($x){ $this->hosts=$x; }
    public function getPorts(){ return $this->ports; }
    public function setPorts($x){ $this->ports=$x; }
    public function getBasedn(){ return $this->basedn; }
    public function setBasedn($x){ $this->basedn=$x; }
    ...
    private function _authenticate($username, $password) {
        ...
        $this->setProxy_user($username);     // ldap rdn or dn
        $this->setProxy_pass($password);  // associated password
        $this->setBasedn('uid='.$this->getProxy_user().',ou=people,dc=facyt,dc=uc,dc=edu,dc=ve');
       
        // conexión al servidor LDAP
        //print_r($this->getHosts());
        ...
        if ($this->ldapconn) {
            ...
            $ldapbind = ldap_bind($this->ldapconn, $this->getBasedn(), $this->getProxy_pass());
